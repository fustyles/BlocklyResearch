...
/**
 * @fileoverview Mutator Workspace To Code.
...
document.addEventListener('DOMContentLoaded', function() {
	...
	Blockly.Blocks["test"] = {
	  init: function() {
		...
		this.setMutator(new Blockly.fuMutator(["controls_if","logic_compare","math_number","variables_get"]));
	  ...
	  myWorkspaceChanged: function(myWorkspace) {
		...
		this.setFieldValue(Blockly.JavaScript.fuMutatorWorkspaceToCode(myWorkspace), "code");
	  }
	};
