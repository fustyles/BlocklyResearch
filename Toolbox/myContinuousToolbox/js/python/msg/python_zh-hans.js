...
Blockly.Msg["WORKSPACE_LANGUAGE"] = "语言环境";
...
Blockly.Msg["WORKSPACE_RESET"] = "重设工作区";
Blockly.Msg["WORKSPACE_RELOAD"] = "重新整理";
Blockly.Msg["WORKSPACE_VERSION"] = "版本资讯";
Blockly.Msg["WORKSPACE_BLOCKFACTORY"] = "积木工厂";
Blockly.Msg["WORKSPACE_BLOCKTOOL"] = "积木工具";
Blockly.Msg["WORKSPACE_BLOCKS_EXPORT_XML_MSG"] = "工作区汇出积木结构XML档案";
Blockly.Msg["WORKSPACE_BLOCKS_IMPORT_XML_MSG"] = "工作区汇入积木结构XML档案";
Blockly.Msg["WORKSPACE_BLOCKS_EXPORT_PY_MSG"] = "工作区汇出PY档";
Blockly.Msg["WORKSPACE_TO_CODE_Y_MSG"] = "即时输出积木程式码";
Blockly.Msg["WORKSPACE_TO_CODE_N_MSG"] = "停止输出积木程式码";
Blockly.Msg["WORKSPACE_RUNCODE"] = "执行文字区块程式码 (Ctrl+Shift)";
...
Blockly.Msg["MATH_NAME"] = "数学";
Blockly.Msg["TEXTS_NAME"] = "字串";
Blockly.Msg["LISTS_NAME"] = "阵列";
Blockly.Msg["COLOUR_NAME"] = "颜色";
Blockly.Msg["VARIABLES_NAME"] = "变数";
